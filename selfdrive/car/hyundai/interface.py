...
#      self.lkas_button_alert = False
    ...
    #자동 재활성 테스트
    if ret.cruiseState.enable and ret.gearShifter == GearShifter.drive:
      print("Gear D and cruise enable")
      #events.append(create_event('pcmEnable', [ET.ENABLE]))
    
    if ret.cruiseState.enable and ret.gearShifter == GearShifter.drive and self.CS.clu_Vanz > 5:
      print("Gear D and cruise enable and speed up 5km/h")
      #events.append(create_event('pcmEnable', [ET.ENABLE]))
