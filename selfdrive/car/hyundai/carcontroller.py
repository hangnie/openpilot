...
#     lkas_active = enabled and self.lkas_button
    ...
    if self.car_fingerprint == CAR.TUCSON_TL:
      if CS.clu11["CF_Clu_CruiseSwState"] == 2 and not self.acc_cruise_state:
...
      if CS.clu11["CF_Clu_CruiseSwState"] == 1 and not self.acc_cruise_state:  
        self.acc_cruise_state = 0
